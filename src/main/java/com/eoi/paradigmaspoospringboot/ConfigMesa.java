...
public class ConfigMesa {
    ...
    // Agregamos un máximo número de patas para generar aleatoriamente
    @Autowired
    ...
    public Mesa mesaRandom()
    {
        ...
        // Creo la herramienta de generación de números aleatorios
        SecureRandom secureRandom = new SecureRandom();

        // Calculamos el número de patas aleatorio entre 0 y 19 (incluido - excluido)
